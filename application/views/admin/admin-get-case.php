...
<!-- content start -->
    <div class="admin-content">
        ...
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">案例编辑管理界面</strong> / <small>Add</small></div>
        </div>
          ...
          <div class="am-tabs-bd">
              <div class="am-tab-panel am-fade am-in am-active" >
                <form action="admin/update_case" method="post" class="am-form am-form-inline" enctype="multipart/form-data" data-am-validator>
                        ...
                        <div class="am-g am-margin-top">
                            ...
                            <div class="am-u-sm-8 am-u-md-4">
                                <input type="text" name="case_user" class="am-input-sm" value="<?php echo $case -> case_user ;?>">
                            </div>
                        ...
                        <div class="am-g am-margin-top">
                            <div class="am-u-sm-4 am-u-md-2 am-text-right">当前案例主图</div>
                            <div class="am-u-sm-8 am-u-md-4 am-u-end">
                                <input type="hidden" name="photo_old_url" value="<?php echo $case -> case_img1 ;?>">
                                <img src="<?php echo $case -> case_img1 ;?>" style="width: 50%; height: 50%; cursor: pointer;" alt="当前文章主图缩略图" title="" data-am-popover="{content: '当前文章主图缩略图', trigger: 'hover focus'}"/>
                            </div>
                        </div>
                        ...
                        <div class="am-g am-margin-top">
                            ...
                            <div class="am-u-sm-8 am-u-md-4">
                                <input type="text" name="case_add" class="am-input-sm" value="<?php echo $case -> case_add ;?>">
                            </div>
                            <div class="am-hide-sm-only am-u-md-6">*必填，不可重复</div>
                        </div>
                        ...
                        <div class="am-g am-margin-top-sm">
                          ...
                          <div class="am-u-sm-8 am-u-md-4 am-u-end">
                            <textarea rows="4" name="case_desc"><?php echo $case -> case_desc ;?></textarea>
                          </div>
                        </div>
