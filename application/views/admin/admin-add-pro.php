...
<div class="admin-content">
  ...
  <div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">新增产品信息管理界面</strong> / <small>Add</small></div>
  </div>
  ...
  <div class="am-tabs am-margin" data-am-tabs>
    ...
    <div class="am-tabs-bd">
        ...
        <div class="am-tab-panel am-fade am-in am-active" >
          <form action="admin/save_pro" method="post" class="am-form am-form-inline" enctype="multipart/form-data" data-am-validator>
            <div class="am-g am-margin-top-sm">
              <div class="am-u-sm-4 am-u-md-2 am-text-right">
                产品名称
              </div>
              <div class="am-u-sm-8 am-u-md-4 am-u-end">
                <input type="text" class="am-input-sm" name="pro_name">
              </div>
            </div>

            <div class="am-g am-margin-top">
              <div class="am-u-sm-4 am-u-md-2 am-text-right">产品品牌</div>
              <div class="am-u-sm-8 am-u-md-10" style="margin-bottom: 20px;">
                  <select name="pro_brand" data-am-selected="{btnSize: 'sm'}">
                    <?php 
            ...
            <div class="am-g am-margin-top-sm">
              ...
              <div class="am-u-sm-8 am-u-md-4 am-u-end">
                <input type="text" class="am-input-sm" name="pro_price">
              </div>
            </div>
            ...
            <div class="am-g am-margin-top-sm">
              ...
              <div class="am-u-sm-8 am-u-md-4 am-u-end">
                <input type="text" class="am-input-sm" name="pro_business">
              </div>
            </div>
            ...
            <div class="am-g am-margin-top-sm">
              ...
              <div class="am-u-sm-8 am-u-md-4 am-u-end">
                <input type="text" class="am-input-sm" name="pro_add">
              </div>
            </div>
            ...
            <div class="am-g am-margin-top-sm">
              ...
              <div class="am-u-sm-8 am-u-md-4 am-u-end">
                <input type="text" class="am-input-sm" name="pro_phone">
              </div>
            </div>
