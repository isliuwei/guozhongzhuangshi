...
<div class="admin-content">
  ...
  <div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">新增广告信息管理界面</strong> / <small>Add</small></div>
  </div>
  ...
  <div class="am-tabs am-margin" data-am-tabs>
    ...
    <div class="am-tabs-bd">
        ...
        <div class="am-tab-panel am-fade am-in am-active" >
          <form action="admin/save_ad" method="post" class="am-form am-form-inline" enctype="multipart/form-data" data-am-validator>
            <div class="am-g am-margin-top-sm">
              <div class="am-u-sm-4 am-u-md-2 am-text-right">
                广告 标题
              </div>
              <div class="am-u-sm-8 am-u-md-4 am-u-end">
                <input type="text" class="am-input-sm" name="ad_title">
              </div>
            </div>
            ...
            <div class="am-g am-margin-top-sm">
              ...
              <div class="am-u-sm-8 am-u-md-4 am-u-end">
                <textarea rows="4" name="ad_desc"></textarea>
              </div>
            </div>
            <div class="am-margin">
