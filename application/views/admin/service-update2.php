...
<div class="admin-content">
  ...
  <div class="am-tabs am-margin" data-am-tabs>
    <ul class="am-tabs-nav am-nav am-nav-tabs">
      <li ><a href="#tab1">编辑场所</a></li>
      <li class="am-active"><a href="#tab2">编辑项目</a></li>
      ...
      <div class="am-tab-panel am-fade am-in am-active" id="tab2">
        <form class="am-form" action="admin/update_service_item" method="post" enctype="multipart/form-data">
          <div class="am-g am-margin-top">
            <input type="hidden" name="service_id" value="<?php echo $service_items[0]->service_id;?>">
            ...
            <select id="items"  style="width:300px">
               <option value="<?php echo $item[0]->service_id;?>" selected="selected"><?php echo $item[0]->service_name;?></option>
               ...
               <option data-id="<?php echo $service_item->service_id;?>" value="<?php echo $service_item->service_id;?>"><?php echo $service_item->service_name;?></option>
                <?php 
                  }
                ?>
            </select>
            ...
            <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
              <input type="text" name="service_name" class="am-input-sm" value="<?php echo $item[0]->service_name?>">
            </div>
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
              <input type="text" name="item_desc" class="am-input-sm" value="<?php echo $item[0]->service_desc?>">
          ...
          <div class="am-g am-margin-top">
            ...
            <img src="<?php echo  $item[0]->service_img;?>" alt="" width="40%" height="40%">
          </div>

          <div class="am-g am-margin-top">
            <input type="hidden" name="photo_old_url" value="<?php echo $item[0]->service_img;?>">
            <div class="am-u-sm-4 am-u-md-2 am-text-right">
              修改图片
            </div>
