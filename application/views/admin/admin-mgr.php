      ...
      <div class="am-u-sm-12">
          ...
          ?>
              <tr>
                ...
                <td><img src="<?php echo $admin -> admin_photo; ?>" width="50px" height="50px" alt="" /></td>
                <td>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      ...
                      <button data-id="<?php echo $admin -> admin_id; ?>" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only am-btn-delete am-hide"><span class="am-icon-trash-o"></span> 删除</button>
                    </div>
                  </div>
                </td>
              </tr>
